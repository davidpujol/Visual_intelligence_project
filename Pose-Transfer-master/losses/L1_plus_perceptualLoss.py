...
class L1_plus_perceptualLoss(nn.Module):
    def __init__(self, lambda_L1, lambda_perceptual, perceptual_layers, use_gpus, percep_is_l1):
        ...
        self.vgg_submodel = torch.nn.DataParallel(self.vgg_submodel, device_ids=[])
        use_gpu = False
        if use_gpu:

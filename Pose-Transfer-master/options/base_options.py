...
class BaseOptions():
     ...
     def initialize(self):
         ...
         self.parser.add_argument('--use_gpus', type=bool, default=False, help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
         ...
         self.parser.add_argument('--nThreads', default=2, type=int, help='# threads for loading data_processing')
         ...
         self.parser.add_argument('--no_flip', action='store_true', help='if specified, do not flip the images for data_processing augmentation')
         ...
         # other options
         self.parser.add_argument('--isTrain', type=int, default=True, help='down-sampling blocks for discriminator')

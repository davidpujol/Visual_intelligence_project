...
class Pose(BaseModel):
    ...
    def __init__(self, opt):
        ...
        #                   'ad_gen', 'dis_img_gen']
        self.loss_names = ['app_gen', 'ad_gen']
        ...
        if self.isTrain:
            ...
            self.Vggloss = external_function.VGGPerceptualLoss().to(opt.device)
    ...
    def backward_G(self):
        ...
        # Calculate regularization term (DOES NOT WORK). FOR NOW DO NOT INCLUDE THIS!!
        ...
        # PERCEPTUAL LOSS
        # Calculate perceptual loss (DOES NOT WORK)
        ...
        self.perceptual_loss = self.Vggloss(self.img_gen, self.input_P2)


        # Sum all the losses together
        total_loss = self.loss_app_gen + self.loss_app_gen + self.loss_correctness_gen + self.perceptual_loss
        total_loss.backward()
